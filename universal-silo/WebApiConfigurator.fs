...
type WebApiConfigurator (apiInfo : OpenApiInfo) = class
    ...
    abstract ConfigureServices : IServiceCollection -> IServiceCollection
    default this.ConfigureServices services =
        services
    ...
    default this.ConfigureWebApiHost builder =
        ...
        |> (fun b -> b.ConfigureServices(fun (services : IServiceCollection) -> this.ConfigureServices services |> ignore))
end
